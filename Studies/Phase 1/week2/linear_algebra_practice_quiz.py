...
theta12 = np.radians(60)
R12 = np.array([
    [np.cos(theta12), -np.sin(theta12)],
...
print(R12)
print("""
질문 12-1: 이 행렬에서 R^T = R^(-1) 인가? (True/False)
질문 12-2: R^T는 기하학적으로 어떤 의미인가? (초간단 설명)
질문 12-3: SLAM에서 이 성질이 왜 유용한가? (한 줄로)
""")
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
✅ 답 12: 전치와 역행렬의 관계
""")
print(f"답 12-1: R^T = R^(-1)? {np.allclose(R12.T, np.linalg.inv(R12))}")
print("""
풀이:
...
print(f"\n답 12-2: R^T는 반대 방향 회전 (역회전)을 의미합니다.")
print(f"       R(60°)^T = R(-60°)")

print("\n답 12-3: 좌표계 역변환을 역행렬 계산 없이 빠르게 수행할 수 있음")
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
✅ 10-12문제 모두 맞춤: 완벽! Week 3으로 진행
✅ 8-9문제: 잘하고 있어요, 틀린 부분 복습 후 진행
⚠️ 5-7문제: 3Blue1Brown 영상 다시 시청 권장
❌ 0-4문제: Week 1부터 다시 복습 필요

💡 SLAM 관련 문제 (5, 7, 8, 12)가 중요합니다!
""")
